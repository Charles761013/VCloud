...
SUPPORT_CONTENT_TYPE = ['video/mp4', 'video/avi', 'video/wmv', 'video/flv', 'video/f4v']
...
class RestrictedFileField(forms.FileField):
    ...
    def clean(self, *args, **kwargs):
        ...
        try:
            ...
            content_category = data.content_type
...
class UploadFileForm(forms.Form):
    ...
    file = RestrictedFileField(content_types=SUPPORT_CONTENT_TYPE)
